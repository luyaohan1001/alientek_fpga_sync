...
module  sdram_top(
    ...
    input         wr0_clk,                  //写端口FIFO: 写时钟
    input         wr0_en,                   //写端口FIFO: 写使能
    input  [15:0] wr0_data,                 //写端口FIFO: 写数据

    input         wr1_clk,                  //写端口FIFO: 写时钟
    input         wr1_en,                   //写端口FIFO: 写使能
    input  [15:0] wr1_data,                 //写端口FIFO: 写数据
...
sdram_fifo_ctrl u_sdram_fifo_ctrl(
    ...
    .clk0_write          (wr0_clk),           //写端口FIFO: 写时钟
    .wrf0_wrreq          (wr0_en),            //写端口FIFO: 写请求
    .wrf0_din            (wr0_data),          //写端口FIFO: 写数据  

    .clk1_write          (wr1_clk),           //写端口FIFO: 写时钟
    .wrf1_wrreq          (wr1_en),            //写端口FIFO: 写请求
    .wrf1_din            (wr1_data),          //写端口FIFO: 写数据  
